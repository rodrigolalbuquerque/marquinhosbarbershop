...
export function Header() {
  ...
  return (
    <header className="absolute z-10 flex h-24 w-full items-center justify-between px-[clamp(24px,6vw,92px)] text-white text-shadow-[0_1px_16px_rgba(0,0,0,.65)] max-md:h-19">
      <a
        href="#inicio"
